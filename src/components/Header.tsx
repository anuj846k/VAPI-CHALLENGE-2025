      ...
      <Container className="!px-0">
        <nav className="shadow-md md:shadow-none bg-white md:bg-transparent mx-auto flex justify-between items-center py-2 px-5 md:py-10">
          ...
          <ul className="hidden md:flex space-x-6">
            <Link
              href="/dashboard"
              className="text-black  border border-red-600 hover:bg-white px-8 py-3 rounded-full transition-colors"
            >
              Open Dashboard
            </Link>
          </ul>
          ...
          {/* Mobile Menu Button */}
          <div className="md:hidden flex items-center justify-center w-full p-4 bg-white">
            <p className="text-center text-sm font-semibold text-red-600">
              This website is not made for mobile screens. Please open on
              desktop for now.
            </p>
          </div>
        </nav>
